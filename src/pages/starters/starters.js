...
function StartersPage() {
  ...
  const url = `https://api.edamam.com/api/recipes/v2?type=public&q=all&app_id=${process.env.REACT_APP_ID}&app_key=%20${process.env.REACT_APP_KEY}&dishType=Starter`;
      ...
      <main className="main">
        <div className="container">
          ...
          <div className="recipe-tile">
            <h2 className="recipe-tile__title">Entradas</h2>
            {error ? (
